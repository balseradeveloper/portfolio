const translations = {
    es: {
        ...
        "proyecto-clima": "Clima-Sites es una herramienta web interactiva que combina información meteorológica en tiempo real con recomendaciones turísticas inteligentes. Diseñada para viajeros, curiosos o locales, permite descubrir qué hacer en una ciudad en función del clima actual.",
        ...
        "proyecto-conciertos": "Ejemplo de diseño web para eventos musicales desarrollado con tecnologías web puras (HTML5, CSS3 y JavaScript vanilla) en 2 horas. Un diseño responsive y moderno, ideal para aquellos que necesiten un cambio visual profesional en su web de conciertos o eventos.",
    ...
    en: {
        ...
        "proyecto-clima": "Clima-Sites is an interactive web tool that combines real-time weather information with intelligent tourist recommendations. Designed for travelers, curious people or locals, it allows you to discover what to do in a city based on the current weather.",
        ...
        "proyecto-conciertos": "Music events website design example developed with pure web technologies (HTML5, CSS3 and vanilla JavaScript) in just 2 hours. A modern and responsive design, ideal for those who need a professional visual change for their concert or events website.",
